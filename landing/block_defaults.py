...
_reg(
    ...
    default=(
        "<p>Спрощена сторінка-каркас. Повний юридичний текст можна відредагувати тут.</p>"
        "<h2>1. Оператор даних</h2>"
        "<p>Kontur+ (ремонтна організація). Контакт: телефон на сайті.</p>"
        "<h2>2. Які дані збираємо</h2>"
        "<p>Ім’я, номер телефону, контекст заявки (пакет, параметри розрахунку), "
        "технічні дані запиту.</p>"
        "<h2>3. Мета обробки</h2>"
        "<p>Зв’язок щодо ремонту, підготовка кошторису, покращення сервісу.</p>"
        "<h2>4. Зберігання та права</h2>"
        "<p>Дані зберігаються стільки, скільки потрібно для обробки звернення. "
        "Ви можете запитати доступ, виправлення або видалення.</p>"
    ),
    multiline=True,
)
