...
CONTENT_SECTIONS: tuple[ContentSection, ...] = (
    ...
    ContentSection(
        ...
        sidebar_icon="image",
        preview_url="/#hero",
        description="Тексти головної секції. Фото каруселі — нижче на цій сторінці.",
    ...
    ContentSection(
        ...
        description="Видимість секції. Картки — у розділі «Картки сайту → Переваги».",
        visibility_key="advantages_section_visible",
        admin_model_name="homeadvantagessettings",
        list_hint="Картки переваг додаються в меню зліва: «Картки сайту → Переваги».",
    ...
    ContentSection(
        ...
        description="Заголовки та фон. Картки пакетів — у «Картки сайту → Пакети».",
        visibility_key="packages_section_visible",
        admin_model_name="homepackagessettings",
        list_hint="Пакети редагуються в меню «Картки сайту → Пакети».",
        blocks=_b(
            "home",
    ...
    ContentSection(
        ...
        preview_url="/#design",
        description="Тексти, фото та кнопка. Пункти списку — у «Картки сайту → Пункти дизайну».",
        visibility_key="design_section_visible",
        admin_model_name="homedesignsettings",
        list_hint="Пункти списку — «Картки сайту → Пункти дизайну».",
        blocks=_b(
            "home",
    ...
    ContentSection(
        ...
        preview_url="/#styles",
        description="Заголовки секції. Картки стилів — у «Картки сайту → Стилі».",
        visibility_key="styles_section_visible",
        admin_model_name="homestylessettings",
        list_hint="Картки стилів — «Картки сайту → Стилі».",
        blocks=_b(
            "home",
    ...
    ContentSection(
        ...
        preview_url="/#proof",
        description="Заголовки. Відгуки й кейси — у «Картки сайту».",
        visibility_key="proof_section_visible",
        admin_model_name="homeproofsettings",
        list_hint="Відгуки та кейси — «Картки сайту».",
        blocks=_b(
            "home",
    ...
    ContentSection(
        ...
        sidebar_icon="help",
        preview_url="/#faq",
        description="Заголовки та фото. Питання — у «Картки сайту → Питання та відповіді».",
        visibility_key="faq_section_visible",
        admin_model_name="homefaqsettings",
        list_hint="Питання додаються в меню: «Картки сайту → Питання та відповіді».",
        blocks=_b(
            "home",
            "faq_section_visible",
            "faq_badge",
    ...
    ContentSection(
        ...
        description="Слоган, послуги, юридичний рядок і toggles.",
